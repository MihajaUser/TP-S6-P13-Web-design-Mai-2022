    ...
    <div class="container">
      <div class="row">
        <div class="templatemo_titlewrapper"><img src="<?php echo base_url() ?>/assets/images/templatemo_logobg.png" alt="logo background">
          <div class="templatemo_title"><span>Rechauffement Climatique</span></div>
        </div>
        <div class="clear"></div>
            ...
            <div id="top-menu">
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                  ...
                  <li><a class="menu" href="#templatemo_contact_page">Se connecter</a></li>
                </ul>
              </div>
            </div>
            <!-- /.navbar-collapse --> 
...
<div class="templatemo_workwrapper" id="templatemo_work_page">
  ...
  <div>
    <div class="templatemo_workbox">
      <div class="gallery-item"><img src="<?php echo base_url() ?>/assets/images/work/1.jpg" alt="work 1">
        <div class="overlay">
    ...
    <div class="templatemo_workbox">
      <div class="gallery-item"><img src="<?php echo base_url() ?>/assets/images/work/2.jpg" alt="work 2">
        <div class="overlay">
    ...
    <div class="templatemo_workbox">
      <div class="gallery-item"><img src="<?php echo base_url() ?>/assets/images/work/3.jpg" alt="work 3">
        <div class="overlay">
    ...
    <div class="templatemo_workbox">
      <div class="gallery-item"><img src="<?php echo base_url() ?>/assets/images/work/4.jpg" alt="work 4">
        <div class="overlay">
    ...
    <div class="templatemo_workbox">
      <div class="gallery-item"><img src="<?php echo base_url() ?>/assets/images/work/5.jpg" alt="work 5">
        <div class="overlay">
    ...
    <div class="templatemo_workbox">
      <div class="gallery-item"><img src="<?php echo base_url() ?>/assets/images/work/6.jpg" alt="work 6">
        <div class="overlay">
    ...
    <div class="templatemo_workbox">
      <div class="gallery-item"><img src="<?php echo base_url() ?>/assets/images/work/7.jpg" alt="work 7">
        <div class="overlay">
    ...
    <div class="templatemo_workbox">
      <div class="gallery-item"><img src="<?php echo base_url() ?>/assets/images/work/8.jpg" alt="work 8">
        <div class="overlay">
    ...
    <div class="row">
      ...
      <div id="w">
        <div class="crsl-items" data-navigation="navbtns">
          <div class="crsl-wrap">
            <div class="crsl-item"><img src="<?php echo base_url() ?>/assets/images/team/01.jpg" alt="person 1">
            ...
            <!-- post #1 -->
            <div class="crsl-item"><img src="<?php echo base_url() ?>/assets/images/team/02.jpg" alt="person 2">
            ...
            <!-- post #2 -->
            <div class="crsl-item"><img src="<?php echo base_url() ?>/assets/images/team/03.jpg" alt="person 3">
              <div class="templatemo_team_name">Mauris Luctus</div>
            ...
            <!-- post #3 -->
            <div class="crsl-item"><img src="<?php echo base_url() ?>/assets/images/team/04.jpg" alt="person 4">
            ...
            <!-- post #4 -->
            <div class="crsl-item"><img src="<?php echo base_url() ?>/assets/images/team/05.jpg" alt="person 5">
              <div class="templatemo_team_name">Mauris Luctus</div>
            ...
            <!-- post #5 -->
            <div class="crsl-item"><img src="<?php echo base_url() ?>/assets/images/team/06.jpg" alt="person 6">
              <div class="templatemo_team_name">Mauris Luctus</div>
      ...
      <div class="clear"></div>
      <nav class="slidernav">
        <div id="navbtns" class="clearfix"><a href="#" class="previous"><img src="<?php echo base_url() ?>/assets/images/slideitmoo_back.png" alt="previous"></a> <a href="#" class="next"><img src="<?php echo base_url() ?>/assets/images/slideitmoo_forward.png" alt="next"></a></div>
      </nav>
    </div>
    <script>
	$(function() {
...
<div class="templatemo_contactwrapper" id="templatemo_contact_page">
  ...
  <div class="container templatemo_contactmargin">
    <div class="row">
      ...
      <form action="<?php echo site_url("/ControllerUsers/accueille") ?>" method="post">
        <div class="col-md-9">
          <div class="col-md-4">
